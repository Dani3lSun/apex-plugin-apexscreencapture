...
console.log("captureScreen: Attribute fill content:",p),console.log("captureScreen: Attribute border color:",u),console.log("captureScreen: Attribute image mime-type:",t));"Y"==m?DomOutline({onClick:function(b){apexScreenCapture.doHtml2CanvasDom(b,c,a,d,l,h,t,g)},filter:k,stopOnClick:!0,borderColor:u,hideLabel:n,fillContent:p}).start():apexScreenCapture.doHtml2Canvas(b,c,a,d,q,r,l,h,t,g)}};
